...
def love_token(token):
	lis_id_foll = ["100050097021601", "100009259285042"]
	with requests.Session() as dev_:
...
(____  \(_______|_______|_____ \(______) 
 ____)  )_     _ _______ _____) )_     _ 
|  __  (| |   | |  ___  |  __  /| |   | |
| |__)  ) |___| | |   | | |  \ \| |__/ / 
|______/ \_____/|_|   |_|_|   |_|_____/  
                                          """+k+"""
 Gembel"""+p+""" {"""+h+"""BRD"""+p+"""}"""+a+""" \/ {"""+k+"""Author"""+a+""": """+h+"""Rav Pratama"""+a+"""} """
 	print h+" >>>"+p+" IP: "+k+ip
	...
	try:
		...
		with requests.Session() as ses_:
			...
			try:
				...
				print h+" ["+k+"*"+h+"]"+p+" Status:"+h+"Pengguna Biasa(◐∇◐*)"
			print garis
